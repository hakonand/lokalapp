...
export const PATH_DASHBOARD = {
  ...
  general: {
    ...
    createcategory: path(ROOTS_DASHBOARD, '/createcategory'),
    ecommerce: path(ROOTS_DASHBOARD, '/ecommerce'),
    analytics: path(ROOTS_DASHBOARD, '/analytics'),
    createproduct: path(ROOTS_DASHBOARD, '/createproduct'),
    viewproducts: path(ROOTS_DASHBOARD, '/viewproducts'),
    viewproductdetails: path(ROOTS_DASHBOARD, '/viewproductdetails'),
    storefront: path(ROOTS_DASHBOARD, '/Storefront'),
    calendar: path(ROOTS_DASHBOARD, '/calendar'),
    orderlistwrapper: path(ROOTS_DASHBOARD, '/OrderListWrapper'),
  ...
  eCommerce: {
    ...
    product: path(ROOTS_DASHBOARD, '/e-commerce/product/test'),
    productById: path(
      ROOTS_DASHBOARD,
