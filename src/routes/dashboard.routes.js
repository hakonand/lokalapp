...
const DashboardRoutes = {
  ...
  routes: [
    ...
    },
    {
      ...
      component: lazy(() => import('../views/StoreAccount/UserAccount'))
    },
    {
      exact: true,
      path: PATH_DASHBOARD.general.maindashboard,
      component: lazy(() => import('../views/dashboard/MainDashboard'))
    },
    {
      exact: true,
      path: PATH_DASHBOARD.general.createcategory,
      component: lazy(() => import('../views/CreateCategory/CreateCategory'))
    },
    {
      exact: true,
      path: PATH_DASHBOARD.user.profile,
      component: lazy(() => import('../views/Storefront/Storefront'))
    },
    {
      exact: true,
      path: PATH_DASHBOARD.general.createproduct,
      component: lazy(() =>
        import('../views/create-product-wizard/ProductWizard')
      )
    },
    {
      exact: true,
      path: PATH_DASHBOARD.general.orderlistwrapper,
      component: lazy(() => import('../views/OrderList/OrderListWrapper.js'))
    },
    {
      exact: true,
      path: PATH_DASHBOARD.general.viewproducts,
      component: lazy(() => import('../views/ViewProducts/ViewProducts'))
    },
    {
      exact: true,
      path: PATH_DASHBOARD.general.calendar,
      component: lazy(() => import('../views/CalendarView/HourListCalendar'))
    },
    {
      exact: true,
    ...
    {
      exact: true,
      path: PATH_DASHBOARD.eCommerce.viewproductdetails,
      component: lazy(() =>
        import('../views/ViewProductDetails/ViewProductDetails')
      )
    },
    {
      exact: true,
